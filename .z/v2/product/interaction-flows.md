...
ユーザーがセッション詳細を開いている間のリアルタイムデータフロー。
...
| high | session_failed, session_orphaned | 常に送信 | 作業損失リスク |
| normal | session_done, session_recovered | 設定に依存 | 情報提供 |
